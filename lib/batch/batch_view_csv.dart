...
final toggleGenerate = StateNotifierProvider<GenericStateNotifier<bool>, bool>(
            ...
            children: <Widget>[
              Padding(
                  ...
                  child: ElevatedButton(
                    key: null,
                    onPressed: () {
                      ref.read(toggleGenerate.notifier).value =
                    ...
                    onPressed: () {
                      if (ref.watch(toggleGenerate)) {
                        ...
                        Fluttertoast.showToast(
                            msg: 'Please generate data for Copy to clipboard',
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () {
                      if (ref.watch(toggleGenerate)) {
                        ...
                        Fluttertoast.showToast(
                            msg: 'Please generate data for Download CSV',
                            timeInSecForIosWeb: 2);
                      }
                    },
                    child: Row(
                                                                ...
                                                                children: [
                                                                  TableRow(
                                                                      children: ((finalData
                                                                              .entries
                                                                              .toList()
                                                                              .where((element) => element.key.toString() != 'time Created' && element.key.toString() != 'author' && element.key.toString() != 'desc')
                                                                              .toList())
                                                                            ..sort((a, b) => a.key.compareTo(b.key)))
                                                                          .map((values) => Column(children: [
                                                                                Text(values.key.toString(), style: TextStyle(fontSize: 18.0, color: Colors.orange))
                                                                              ]))
                                                                          .toList())
                                                                ]);
                                                          } else {
                      ...
                      child: SingleChildScrollView(
                          child: ref
                              ...
                              .when(
                                  ...
                                  data:
                                      (selectEntities) =>
                                          selectEntities.size == 0
                                              ? Container()
                                              : Column(
                                                  children: selectEntities.docs
                                                      .map((select) {
                                                  return ref
                                                      .watch(colSP(
                                                          '${select.data()['ref'].path}/transaction'))
                                                                      ...
                                                                      children: entities
                                                                        ...
                                                                        (entity) {
                                                                          Map<String, dynamic>
                                                                              finalData =
                                                                              {};
                                                                          ref.watch(docSP(select.data()['ref'].path.toString())).whenData(
                                                                              (value) {
                                                                          ...
                                                                          (finalData.entries.toList()..sort((a, b) => a.key.compareTo(b.key)))
                                                                              .forEach((element) {
                                                                          ...
                                                                          exportList
                                                                              .add(tempdata);
                                                                          return Table(
                                                                              border: TableBorder.all(color: Colors.grey, style: BorderStyle.solid, width: 0.5),
                                                                              children: [
                                                                                TableRow(
